...
#### 3.6.1. Tiêu đề bảng theo chiều dọc
...
#### 3.6.2. Tiêu đề cho nhiều cột
- Sử dụng thuộc tính `colspan` cho phần tử `<th>`
    <p align = "center">
    <img width = 500 src="../images/lesson2/span_th.png">
    </p>

### 3.7 HTML Table Styling
- Sử dụng CSS để tạo kiểu cho bảng trông đẹp mắt hơn.
- Bảng có màu nền xen kẽ giữa các hàng, các cột
    - Sử dụng bộ chọn :nth-child(enven) (cột hoặc hàng chẵn), :nth-child(enven) (cột hoặc hàng lẻ)
    - VD: <p align = "center">
    <img width = 500 src="../images/lesson2/zebra_tb.png">
    </p>
- Bảng có border ngang: Nếu muốn chỉ định đường viền ở cuối mỗi hàng trong bảng, ta sẽ có một bảng với các đường chia ngang.
    - Thêm thuộc tính `border-bottom` vào tất cả các phần tử `<tr>` để có được các dải phân cách ngang: 
    ```css
    tr {
...
*Lưu ý*: Thẻ `<colgroup>` phải là thẻ con của phần tử `<table>`, và nên đặt trước bất kỳ thẻ nào khác trong table, trừ thẻ `<caption>`
...
<p align = "center">
<img width = 500 src="../images/lesson2/nest_list.png">
</p>
- HTML lists có thể được đặt `style` với nhiều cách khác nhau bằng cách sử dụng CSS, một cách phổ biến là danh sách nằm ngang (còn gọi là menu ngang), ứng dụng của nó là làm thành `navigation ba`r (thanh điều hướng).
...
```
<p align = "center">
<img width = 500 src="../images/lesson2/nest_ol.png">
</p>
...
### 4.3. HTML Description List: danh sách mô tả
